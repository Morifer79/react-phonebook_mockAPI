...
1. Clone the repository:
   ```bash
   git clone https://github.com/Morifer79/react-phonebook_mockAPI.git
   cd react-phonebook_mockAPI-app
   ```
...
<a href="https://morifer79.github.io/react-phonebook_mockAPI/"><img src="https://badgen.net/badge/🌎 www:/Phonebook API/yellow?icon=browser" alt="Badge"/></a>
